    ...
    return(
        <Dialog open={openPopup} onClose={handleClosePopup} sx={{ textAlign: 'center', mt: 4 }}>
            ...
            <Box sx={{ p: 2, pt: 0, pr: 4, textAlign: "left", fontSize: '20px', fontFamily: 'Roboto, sans-serif' }}>
                {/* <p>Инструкция:</p> */}
                <ol>
                    <li>Если вы уже знаете куда записать ребенка, жмем на кнопку в панели фильтров снизу слева "Записаться", которая переводит сразу на yandex-форму.</li>
                    <li>Фильтры в каталоге помогут быстро выбрать нужную по возрасту и интересам ребенка образовательную программу.</li>
                    <li>
