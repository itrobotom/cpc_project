    ...
    <>
        <Container style={{paddingTop: "100px", paddingBottom: "50px"}}>
            ...
            <Accordion>
                ...
                <AccordionDetails>
                <Typography>
                    Рекомендуем обратиться к каталогу услуг, где можно выбрать по интересам и возрасту подходящую программу. Также доступны консультации специалистов методического центра. С 11 лет доступно тестирование для определения приоритетных интересов ребенка. Перейдите по ссылке “каталог услуг ЦПК” и откройте слева в панели фильтров “инструкция”.
